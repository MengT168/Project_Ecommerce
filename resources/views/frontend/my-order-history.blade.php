                ...
                <div class="card">
                    <div class="table-responsive">
                        <table class="table table-borderless table-shopping-cart">
                            ...
                            <tbody>
                            @foreach ($subscribeItems as $subscribeItemVal )
                                <tr>
                                <td>
                                    <div class="price-wrap"> <h5>{{$subscribeItemVal->id}}</h5></div>
                                    </td>
                                    <td>
                                    <div class="price-wrap"> <h5>{{$subscribeItemVal->name}}</h5></div>
                                    </td>
                                    <td>
                                    <img src="/uploads/{{$subscribeItemVal->thumbnail}}" width="80px" alt="">
                                    </td>
                                    <td>
                                        <div class="price-wrap"> <h5>{{$subscribeItemVal->price}} $</h5></div>
                                    </td>
                                    <td>
                                        <div class="price"> <h6>{{$subscribeItemVal->created_at}}</h6></div>
                                    </td>
