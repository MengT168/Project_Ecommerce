...
@if (Request::get('cart_id'))
    ...
    <div class="container">
        ...
        @csrf
        <label for="">Credit Card ID</label>
            <input required type="text" class="form-control" name="visa" >
            <!-- <label for="">Shipping Address</label>
            <textarea required name="address" id="" class="form-control" ></textarea> -->
            <button type="submit" class="btn btn-primary" style="margin-top: 5px; width: 200px; float: right; " >Subscribe</button>
