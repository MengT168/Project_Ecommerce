                    ...
                    <div class="card">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right d-none d-md-block">
                                            <a href="/remove-cartitem/{{ $cartVal->id }}" class="btn btn-light" data-abc="true"> Remove</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <div class="card" style="width: 300px; margin-left: 12px;">
                                <div class="price-wrap">
                                    <h4>Total Amount : {{ $cartItems[0]->total_amount }} $</h4>
                                </div>
                            </div>
                            <a href="/check-out" class="btn btn-primary" style="margin-top: 5px; width: 200px; float: right;">Check Out</a>
                            @else
                            <main class="shop">
