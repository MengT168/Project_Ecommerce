...
.visible-xs {
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">ADMIN || {{Auth::user()->name}}</span>
            </a>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    ...
                    <img src="/uploads/{{ Auth::user()->image }}" width="150" height="150" alt class=" rounded-circle" style="object-fit: cover;" />
                    </div>
                  </a>
    ...
    <script src="{{url('backend1/js/theme.js')}}"></script>

    {{-- select2 --}}
    <script src="{{url('https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js')}}"></script>

    <!-- Page JS -->
    <script src="{{url('backend1/js/form-basic-inputs.js')}}"></script>
